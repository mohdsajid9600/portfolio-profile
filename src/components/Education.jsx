  ...
  return (
    <section id="education" className="section-container">
      ...
      <div className="max-w-4xl mx-auto relative px-2 sm:px-0">
        ...
        <div className="absolute top-4 bottom-4 left-4 sm:left-8 w-0.5 bg-gradient-to-b from-indigo-500 via-purple-500 to-emerald-400 opacity-30 pointer-events-none" />
        ...
        <div className="flex flex-col gap-8 sm:gap-10">
          {educationList.map((edu, idx) => (
            ...
            >
              ...
              {/* Education Card */}
              <div className="glass-card flex-1 p-6 sm:p-7 flex flex-col gap-4 text-left border border-slate-800/80 hover:border-indigo-500/40 hover:-translate-y-1.5 transition-all duration-300 w-full shadow-card hover:shadow-glow">
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 border-b border-slate-800/80 pb-4">
                  ...
                  <div className="flex flex-wrap sm:flex-col items-start md:items-end gap-2 shrink-0">
                    {/* Duration Badge */}
